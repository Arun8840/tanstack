    ...
    <div className="size-full gap-3">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and manage your account details, security settings, and
            personal information associated with this profile.
          </CardDescription>
        </CardHeader>
          ...
          <div className="flex  gap-3">
            ...
            <div className="flex-1 flex flex-col justify-between gap-3">
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-x-2">
                  <Badge
                    aria-checked={user?.emailVerified}
                    className="bg-red-500/20 text-red-500 aria-checked:bg-green-500/20 aria-checked:text-green-500"
                  >
                    <Star />
